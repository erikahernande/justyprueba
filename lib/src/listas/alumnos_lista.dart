...
class AlumnosLista extends StatelessWidget {
  ...
  Future _listarAlumnos() async {
    try {
      final response =
          await http.post(Uri.parse("http://127.0.0.1/justy/leeralumno.php"));
          ...
          return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return _campoUsuario(
                    context, alumno["nombre"], alumno["numControl"].toString());
              });
        }
      },
    );
            ...
            IconButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => AlumnoPage(idAlumno: idAlumno)),
                  );
                },
