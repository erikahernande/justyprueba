...
class DocentesLista extends StatelessWidget {
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                Map docente = snapshot.data[index];
                return _campoUsuario(
                    context, docente["nombre"], docente["idDoc"].toString());
              });
        }
      },
    );
  ...
  Widget _campoUsuario(BuildContext context, String nombre, String idDocente) {
    final size = MediaQuery.of(context).size;
            ...
            IconButton(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            DocentesPage(idDocente: idDocente)),
                  );
                },
